...
const Profile = () => {
    ...
    const fetchApi = async () => {
        const response = await axios.get("https://jj-server-thunderarby-thunderarbys-projects.vercel.app/api/data");
        ...
        const fetchUserData = async () => {
            try {
                ...
                if (response.data.profile_pic) {
                    setPreviewUrl(`https://jj-server-thunderarby-thunderarbys-projects.vercel.app/profile_pic/${response.data.id}`);
                }
            } catch (error) {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axios.post(
                `https://jj-server-thunderarby-thunderarbys-projects.vercel.app/upload_profile_pic/${userData.id}`,
                formData,
                {
                    headers: {
